        ...
        <div className="settings-grid">
          <section className="setting-panel">
            ...
            <form className="budget-form" onSubmit={saveBudgetCycle}>
              ...
              {isAdmin ? <button className="dark-button" disabled={isSaving} type="submit">예산 주기 저장</button> : <p className="read-only-note">관리자만 예산 주기를 변경할 수 있습니다.</p>}
            </form>
          </section>
          ...
          <section className="setting-panel">
            ...
            <form className="budget-form" onSubmit={saveMonthly}>
              <label><span>주기 기준 월</span><input onChange={(event) => { const month = event.target.value; setError(null); setYearMonth(month); void loadBudget(month); }} type="month" value={yearMonth} /></label>
