  ...
  return (
    ...
    >
      ...
      <section>
        <h2>보관 기간</h2>
        <ul>
          <li>이메일, 표시 이름, 비밀번호, 프로필 사진, 로그인 세션, 비밀번호 재설정 토큰과 Push 구독 정보는 탈퇴 처리 시 즉시 삭제하거나 계정과 연결할 수 없도록 비식별화하며, 별도로 추가 보관하지 않습니다.</li>
          <li>공유 장부의 식비 기록과 탈퇴 상태를 나타내는 비식별 정보는 다른 참여자가 장부를 사용하는 동안 유지되며, 마지막 관리자가 장부를 종료하면 함께 삭제됩니다.</li>
          <li>비식별 처리된 공유 기록에는 탈퇴 사용자의 기존 이메일, 표시 이름, 비밀번호와 프로필 사진이 포함되지 않습니다.</li>
        </ul>
      </section>
